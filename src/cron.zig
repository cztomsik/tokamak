...
test "expr.next()" {
    ...
    try expectNext("0 0 * * *", .{
        .{ 0, 86400 }, // 00:00:00 -> next midnight
        .{ 1, 86400 }, // 00:00:01 -> next midnight
        .{ 23 * 3600 + 59 * 60, 24 * 3600 }, // 23:59 -> 00:00 next day
        .{ 86400, 172800 }, // Jan 2 00:00 -> Jan 3 00:00 (exact match skips to next)
    });
    ...
    try expectNext("0 0 31 * *", .{
        .{ 0, 30 * 86400 }, // Jan 1 -> Jan 31
        .{ 30 * 86400, 89 * 86400 }, // Jan 31 -> Mar 31 (Feb has no 31st)
        .{ 89 * 86400, 150 * 86400 }, // Mar 31 -> May 31 (Apr has no 31st)
        .{ 150 * 86400, 211 * 86400 }, // May 31 -> Jul 31
        .{ 211 * 86400, 242 * 86400 }, // Jul 31 -> Aug 31 (consecutive)
        .{ 242 * 86400, 303 * 86400 }, // Aug 31 -> Oct 31 (Sep has no 31st)
        .{ 303 * 86400, 364 * 86400 }, // Oct 31 -> Dec 31
    });
    ...
    try expectNext("0 9 * * 1-5", .{
        .{ 0, 9 * 3600 }, // Jan 1 (Thu) 00:00 -> Jan 1 (Thu) 09:00
        .{ 9 * 3600, 1 * 24 * 3600 + 9 * 3600 }, // Jan 1 (Thu) 09:00 -> Jan 2 (Fri) 09:00
        .{ 1 * 24 * 3600 + 9 * 3600, 4 * 24 * 3600 + 9 * 3600 }, // Jan 2 (Fri) -> Jan 5 (Mon) 09:00 (skip Sat/Sun)
        .{ 4 * 24 * 3600 + 9 * 3600, 5 * 24 * 3600 + 9 * 3600 }, // Jan 5 (Mon) -> Jan 6 (Tue) 09:00
    });
}
